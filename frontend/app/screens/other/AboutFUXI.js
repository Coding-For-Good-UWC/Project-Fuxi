            ...
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
                    ...
                    <View style={styles.section}>
                        ...
                        <Text style={styles.sectionText}>
                            The app will remember your preferences and the more you use the app the more effective it will become. Recommended music
                            is catered especially towards People with Dementia, as it is based on a wealth of research from caregivers and healthcare
                            providers.
                        </Text>
                    </View>
